...
public class ConfigBean {
    ...
    private final Collection<String> typeParameters = new ArrayList<>(1);
    ...
    private final Map<String, String> directAttributes = new HashMap<>();
    private final Map<String, String> refAttributes = new HashMap<String, String>();
    private final Collection<String> attributeOrder = new CopyOnWriteArrayList<>(); // this one needs to be thread safe since used at runtime to create the instance
